...
import { create_market_analyst } from '../../nodes/analysts/market_analyst';
import { create_news_analyst } from '../../nodes/analysts/news_analyst';
import {
  create_research_manager,
  RESEARCHER_MANAGER_NODE,
} from '../../nodes/managers/research_manager';
import { create_risk_manager, RISK_MANAGER_NODE } from '../../nodes/managers/risk_manager';
import {
  BEAR_RESEARCHER_NODE,
  create_bear_researcher,
} from '../../nodes/researchers/bear_researcher';
import {
  BULL_RESEARCHER_NODE,
  create_bull_researcher,
} from '../../nodes/researchers/bull_researcher';
import { create_risky_analyst, RISKY_ANALYST_NODE } from '../../nodes/risk/aggresive_debator';
import { create_neutral_analyst, NEUTRAL_ANALYST_NODE } from '../../nodes/risk/neutral_debator';
import { create_safe_debator, SAFE_ANALYST_NODE } from '../../nodes/risk/safe_debator';
import { create_trader, TRADE_NODE } from '../../nodes/trader/trader';
...
export class GraphSetup {
  ...
  setupGraph(selected_analysts: AnalystType[] = ['market', 'news']) {
    ...
    workflow.addEdge(RESEARCHER_MANAGER_NODE as any, TRADE_NODE as any);
    workflow.addEdge(TRADE_NODE as any, RISKY_ANALYST_NODE as any);

    workflow.addConditionalEdges(
      (RISKY_ANALYST_NODE as any),
    ...
    workflow.addEdge(RISK_MANAGER_NODE as any, END);
