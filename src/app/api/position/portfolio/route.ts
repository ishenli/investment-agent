...
class PositionPortfolioHttpController extends BaseController {
  static controller = new PositionBizController();
  
  @WithRequestContext()
  static async GET(request: Request) {
    const json = await super.getQuery(request);
    return Response.json(await PositionPortfolioHttpController.controller.getPortfolio(json));
  }
}

export const GET = PositionPortfolioHttpController.GET;
