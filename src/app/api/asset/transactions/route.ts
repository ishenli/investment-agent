...
class AssetAccountTransactionsHttpController extends BaseController {
  ...
  static async GET(request: Request) {
    ...
    return Response.json(
      await AssetAccountTransactionsHttpController.controller.getTransactionHistory(json),
    );
  }
  ...
  static async POST(request: Request) {
    ...
    return Response.json(
      await AssetAccountTransactionsHttpController.controller.addTransaction(body),
    );
  }
}
