...
export const dbSchemaV2 = {
  ...
  sessions: '&id, type, group, slug, meta.title, meta.description, meta.tags, createdAt, updatedAt',
...
export const dbSchemaV4 = {
  ...
  sessions:
    '&id, type, group, pinned, slug, meta.title, meta.description, meta.tags, createdAt, updatedAt',
};
...
export const dbSchemaV9 = {
  ...dbSchemaV7,
  messages:
    '&id, role, content, fromModel, favorite, userLikeTag, dislikeReason, tool_call_id, plugin.identifier, plugin.apiName, translate.content, createdAt, updatedAt, sessionId, topicId, quotaId, parentId, [sessionId+topicId], traceId',
};

export const dbSchemaV10 = {
  ...dbSchemaV9,
  threads:
    '&id, title, type, status, topicId, sourceMessageId, parentThreadId, clientId, userId, lastActiveAt, createdAt, updatedAt, [topicId+sourceMessageId]',
};
