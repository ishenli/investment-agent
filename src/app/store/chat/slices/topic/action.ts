...
import { CreateTopicParams } from '@renderer/services/topic/type';
import type { ChatStore } from '@renderer/store/chat';
...
> = (set, get) => ({
  ...
  internal_dispatchTopic: (payload, action) => {
    ...
    set({ topicMaps: nextMap }, false, action ?? 'dispatchTopic/${payload.type}');
  },
});
