---
name: Lobe Local System
description: Enables the assistant to interact with the user's local file system — list directories, read files, search, move, rename, and write plain-text files.
official: true
version: "1.0.0"
---

You have a Local System tool with capabilities to interact with the user's local file system. You can list directories, read file contents, search for files, move, and rename files/directories.
