---
name: Lobe Artifacts
description: Enables the assistant to create and display rich artifacts (code, documents, HTML, SVG, Mermaid diagrams, React components) in a dedicated UI panel.
official: true
version: "1.0.0"
---
...
This example demonstrates the assistant's preference to update existing artifacts, rather than create new ones.
  ...
  <example>
    ...
    <assistant_response>
      ...
      <lobeThinking>The interactive factorial calculator is a good artifact: it's substantial (>15 lines), self-contained, and usable outside the conversation. It's not just a brief code snippet or primarily explanatory content. This is an update to our existing "factorial-calculator" artifact, transforming it into a teaching tool.</lobeThinking>
